      ...
      >
        ...
        <div className="relative w-full h-full p-10 bg-white/90 backdrop-blur-2xl rounded-[calc(2rem-3px)]">
            <div className="text-center mb-10">
                ...
                <h2 className="text-3xl font-black text-black tracking-tight">Sign In</h2>
                <p className="text-gray-500 mt-2 text-sm font-medium">Access your personalized universe.</p>
            </div>
            ...
            <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full py-4 mt-4 rounded-xl bg-black text-white font-bold hover:bg-[#008000] hover:shadow-[0_0_20px_rgba(0,128,0,0.4)] transition-all duration-300 disabled:opacity-50 flex justify-center items-center"
            >
                {loading ? (
            ...
            <p className="mt-8 text-center text-sm font-medium text-gray-600">
                New to the platform? <a href="/register" className="text-[#008000] font-bold hover:underline transition-colors">Create an account</a>
            </p>
        </div>
      </motion.div>
    </div>
